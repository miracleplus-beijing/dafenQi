...
Page({
          ...
          if (res.statusCode === 200) {
            const podcasts = res.data.map(podcast => {
              ...
              if (channelId === '59e0fed4-8c47-4849-9cc3-a3b819771d65') {
                ...
                // 经典论文解读频道
                channelCoverUrl =
                  'https://gxvfcafgnhzjiauukssj.supabase.co/storage/v1/object/public/static-images/podcast_cover/classic_paper_interpretation.png';
              } else {
                // 默认封面
                channelCoverUrl =
  ...
  arrangeHotRankings: function (podcasts) {
    ...
    const remainingPodcasts = podcasts
      .filter(p => p.id !== qiji910Id && p.id !== attentionId)
  ...
  onShareTimeline: function () {
    return {
      ...
      imageUrl:
        'https://gxvfcafgnhzjiauukssj.supabase.co/storage/v1/object/public/static-images/icons/share-cover.jpg',
    };
  },
});
