...
Page({
  ...
  computed: {
    canSubmit: function() {
      return this.data.selectedType && this.data.feedbackContent.trim() && !this.data.isSubmitting
    }
  },
  ...
  updateCanSubmit: function() {
    const canSubmit = this.data.selectedType && this.data.feedbackContent.trim() && !this.data.isSubmitting
    this.setData({
      canSubmit: canSubmit
    })
  },
