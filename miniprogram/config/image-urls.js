...
const SUPABASE_BASE_URL = 'https://gxvfcafgnhzjiauukssj.supabase.co/storage/v1/object/public/static-images'
...
function getImageUrl(localPath, fallback = null) {
  // 清理路径
  const cleanPath = localPath.replace(/^.*[\\\/]images[\\\/]/, '').replace(/^images[\\\/]/, '')
